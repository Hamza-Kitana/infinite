...
export const organizationalRules = [
...
export const crimeNegotiationRules = [
...
export const specificPenalties = [
...
export const robberyPeopleRules = [
...
export const directPoliceUnitsRules = [
