...
export const interiorMinistryOverview: InstitutionRosterData = {
  leader: {
    ...
    bio: "يرأس التخطيط الأمني العام وغرفة العمليات المركزية، ويتابع جاهزية الشرطة والشرف والاستخبارات والمارينز بالتنسيق مع الإدارة العليا.",
    highlights: [
  ...
  deputy: {
    ...
    bio: "يدعم وزير الداخلية في متابعة الأذرع التشغيلية، والبلاغات الساخنة، والانضباط والتدريب المشترك بين الشرطة والشرف والـ CIA والمارينز.",
    highlights: [
...
export const policeDepartmentRoster: InstitutionRosterData = {
  ...
  deputy: {
    ...
    highlights: [
      "تنسيق الاستجابة مع الشرف والمارينز في العمليات المشتركة.",
...
export const sheriffDepartmentRoster: InstitutionRosterData = {
  leader: {
    ...
    bio: "يقود قوات الشرف في الدوريات الريفية والمطارات البعيدة، والملاحقة طويلة المدى، والتنسيق مع تحقيقات المخدرات والعصابات.",
    highlights: [
  ...
  deputy: {
    ...
    bio: "يدعم قائد الشرف في توزيع الوحدات الميدانية والدوريات الليلية في الأطراف، ومتابعة فرق SWAT التابعة للشرف.",
    highlights: [
